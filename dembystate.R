...
cat("========================================\n")
cat("Democrat by State Analysis\n")
cat("========================================\n")
...
write.csv(results_df, 
          file = file.path(output_dir, "democrat_by_state_detailed_results.csv"),
          row.names = FALSE)
...
write.csv(simple_df,
          file = file.path(output_dir, "democrat_by_state_simple_results.csv"),
          row.names = FALSE)
...
write.csv(weight_df,
          file = file.path(output_dir, "democrat_by_state_weights.csv"),
          row.names = FALSE)
cat("  3. Weights saved\n")
...
write.csv(summary_stats,
          file = file.path(output_dir, "democrat_by_state_summary_statistics.csv"),
          row.names = FALSE)
...
write.csv(metadata,
          file = file.path(output_dir, "democrat_by_state_metadata.csv"),
          row.names = FALSE)
...
plot(results_sorted$TE, y_positions,
     ...
     main = "Treatment Effects on Probability Democrat Runs by State",
